...
public final class NodeBundle {
    ...
    public static final NodeBundle EMPTY;
    ...
    public NodeBundle(String action, String packageName) {
        this();
        this.action = action;
     ...
     */
    public NodeBundle(ClassLoader loader) {
        mMap = new ArrayMap<>();
        mClassLoader = loader;
    }
     ...
     */
    public NodeBundle(int capacity) {
        mMap = new ArrayMap<>(capacity);
        mClassLoader = getClass().getClassLoader();
    }
     ...
     */
    public NodeBundle(NodeBundle b) {
        if (b.mMap != null) {
    ...
    /**
     * 为了方便使用Intent去打开Fragment.
     */
    public NodeBundle(Intent intent) {
     ...
     * @hide
     */
    public static NodeBundle forPair(String key, String value) {
        NodeBundle b = new NodeBundle(1);
     ...
     */
    public void putBundle(String key, NodeBundle value) {
     ...
     */
    public NodeBundle getBundle(String key) {
    ...
    public String toString() {
        return mMap == null ? "null" : mMap.toString();
    }
}
